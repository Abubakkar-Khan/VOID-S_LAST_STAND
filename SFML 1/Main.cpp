...
int main() {
    ...
    sf::RectangleShape player(sf::Vector2f(50, 70));

    player.setFillColor(sf::Color::White);
    player.setOrigin(25, 35);  // Set the origin to the center of the player
    ...
    Animation animation(&playerTexture, sf::Vector2u(5, 2), 0.3f);
